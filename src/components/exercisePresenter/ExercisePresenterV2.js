...
const ExercisePresenterV2 = ({
  ...
  const updateSetsInTemplate = (newSets) => {
    if (orderInTemplate !== null) {
      const exerciseInTemplate = exercisesInTemplate.find(
    ...
    >
      {orderInTemplate !== null && (
        <div className="exercise-presenter__order-box">
          <span className="exercise-presenter__order">{orderInTemplate}</span>
        </div>
      )}

      <div className="exercise-presenter__info-box">
        <span className="exercise-presenter__name">{name}</span>
        <p className="exercise-presenter__description">{description}</p>
      </div>
      ...
      <div className="exercise-presenter__actions-box">
        <figure
          ...
          className={`
                        ...
                        ${
                          !actionsEnabled
                            ? "exercise-presenter__icon-box--disabled"
                            : ""
                        }
                        `}
        ...
        >
          <ion-icon
            name="trash-outline"
            className="exercise-presenter__icon"
          ></ion-icon>
        </figure>
