      ...
      <nav className={styles.navBar}>
        ...
        {user && (
          <div className={styles.navBarLinksContainer}>
            <NavLink
              className={({ isActive }) =>
                isActive ? styles.navBarLinkActive : styles.navBarLinks
              }
              to="/createTemplate"
            >
              Create Template{" "}
        ...
        <div className={styles.navBarLoginContainer}>
          {!user ? (
            <>
              <NavLink className={styles.navBarLinks} to="/login">
                Login
              </NavLink>
              <NavLink className={styles.navBarLinks} to="/register">
                Register
              </NavLink>
            </>
          ) : (
            <>
              {/* TODO later? modify and style as needed */}
