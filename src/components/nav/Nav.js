  ...
  return (
    <nav className="nav-horizontal">
      {currentLocation === "/" ? (
        <ScrollLinkToId
          to="hero-section"
          className="nav-horizontal__logo-box"
          {...scrollConfig}
        >
          <img
            src="/images/logos/logo_border_small.svg"
            alt="logo"
            className="nav-horizontal__logo"
          />
        </ScrollLinkToId>
      ) : (
          ...
          {items.map((item, index) => (
            <li key={index} className="nav-horizontal__item">
              {item.path ? (
                ...
                <ScrollLinkToId
                  to={item.id}
                  className="nav-horizontal__link"
                  {...scrollConfig}
                >
                  {item.text}
                </ScrollLinkToId>
      ...
      <div className="nav-horizontal__actions-box">
        <button
          className="plain-btn nav-horizontal__action-link"
        ...
        {!userIsLoggedIn && (
          <Link
            to="/login"
            className="nav-horizontal__action-link nav-horizontal__action-link--login"
          >
            {loginText}
          </Link>
        )}
        ...
        {!userIsLoggedIn && (
          <Link
            to="/register"
            className="nav-horizontal__action-link nav-horizontal__action-link--cta"
          >
            {signUpText}
          </Link>
        )}
        ...
        {userIsLoggedIn && (
          <Link
            to="/app/home"
            className="nav-horizontal__action-link nav-horizontal__action-link--cta nav-horizontal__action-link--app"
          >
            app
          </Link>
        )}
