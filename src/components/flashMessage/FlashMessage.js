    ...
    >
      ...
      <figure
        className={`
                    ...
                    ${
                      type === "success"
                        ? "flash-message__icon-box--success"
                        : ""
                    }
      ...
      <div className="flash-message__content-box">
        <span className="flash-message__title">{title}</span>
        <span className="flash-message__description">{description}</span>
      </div>

      <div className="flash-message__close-box" onClick={onClose}>
